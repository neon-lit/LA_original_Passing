...
export function Inspector({
  ...
  const defaultHeadlineSize = 139;
  const headlineFontSize = Math.round(slide.headlineFontSize ?? defaultHeadlineSize);
          ...
          {!isFeatureGraphic && (
            <div className="space-y-1.5 pt-1">
              ...
              <input
                ...
                onChange={(event) =>
                  onChange({ headlineFontSize: Number(event.currentTarget.value) })
                }
